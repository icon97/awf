...
if exists("*.uproject") OR brain.json.project.type === "game":
    → Chế độ: Game Brainstorming
    → Load: game_engine config from brain.json
    → Show: Game-specific brainstorm options
```

### Game Types/Genres:

#### Main Genres:
| Genre | Examples | Key Mechanics |
|-------|----------|---------------|
| **Racing** | Need for Speed, Forza | Physics, AI opponents, tracks |
| **FPS** | Call of Duty, Valorant | Shooting, movement, weapons |
| **RPG** | Elden Ring, Witcher | Stats, inventory, quests |
| **Strategy** | Civilization, StarCraft | Resources, units, AI |
| **Puzzle** | Portal, Tetris | Logic, physics, patterns |
| **Platformer** | Mario, Celeste | Jumping, obstacles, levels |
| **Sports** | FIFA, NBA 2K | Physics, teams, seasons |
| **Simulation** | Cities Skylines, Sims | Systems, economy, AI |
| **Battle Royale** | Fortnite, PUBG | Shrinking zone, loot, survival |
| **MOBA** | LoL, Dota 2 | Lanes, heroes, teamfights |

#### Sub-Genres:
| Sub-Genre | Parent | Unique Elements |
|-----------|--------|-----------------|
| Roguelike | RPG | Permadeath, procedural |
| Metroidvania | Platformer | Exploration, abilities |
| Souls-like | Action RPG | Difficulty, stamina |
| Auto-battler | Strategy | Auto-combat, positioning |
| Extraction | FPS | Loot, escape, risk |

### Game Mechanics Brainstorm:

#### Core Mechanics:
```
"🎮 Game cần mechanics gì?"

1️⃣ **Movement** - Di chuyển
   - Walking, Running, Jumping
   - Driving, Flying, Swimming
   - Teleporting, Dashing

2️⃣ **Combat** - Chiến đấu
   - Melee, Ranged, Magic
   - Combos, Blocking, Dodging
   - Health, Damage, Armor

3️⃣ **Progression** - Tiến trình
   - XP, Levels, Skills
...
#### Racing Game Mechanics (PrototypeRacing):
| Mechanic | Implementation | UE5 System |
|----------|----------------|------------|
| Vehicle Physics | Chaos Vehicles or Custom | Physics Subsystem |
| Nitro Boost | Temporary speed increase | Ability System |
| Drifting | Angle-based bonus | Input + Physics |
| Collision | Damage, spin-out | Chaos Physics |
| AI Opponents | Racing line, rubber-banding | AI Controller |
| Track System | Checkpoints, laps | Actor + Triggers |
| Minimap | Real-time position | UMG Widget |
| Customization | Parts, colors, decals | Data Assets |
...
|-------|------|------|----------|
| **Premium** | Upfront revenue | Limited reach | AAA, indie |
| **F2P + IAP** | Wide reach | Balancing | Mobile, live service |
| **Subscription** | Recurring revenue | Content pressure | MMO, service |
| **Ad-supported** | Free for users | User experience | Casual mobile |
| **DLC/Season Pass** | Extended revenue | Content creation | Story games |
...
### Feature Prioritization (Game):

#### MoSCoW for Games:
| Priority | Features | Example (Racing) |
|----------|----------|------------------|
| **Must Have** | Core loop playable | Drive, finish race |
| **Should Have** | Expected features | Multiplayer, customization |
| **Could Have** | Nice additions | Weather, day/night |
| **Won't Have** | Out of scope | Open world, story mode |
...
- [ ] 1 playable vehicle
- [ ] 1 complete track
- [ ] Basic physics (accelerate, brake, steer)
- [ ] Start/Finish detection
- [ ] Lap counter
- [ ] Basic UI (speed, position)
...
|-----------|----------------------|
| Core Loop | Vòng lặp chính của game (chơi → thưởng → lặp lại) |
| MVP | Minimum Viable Product - bản game tối thiểu chơi được |
| USP | Unique Selling Point - điểm khác biệt của game |
| F2P | Free to Play - chơi miễn phí |
| IAP | In-App Purchase - mua trong game |
| Roguelike | Game chết là mất hết, bắt đầu lại |
| Metroidvania | Game khám phá, mở khóa khu vực bằng abilities |
| Rubber-banding | AI tự điều chỉnh độ khó (đuổi kịp khi thua) |
