...
2. Check latest version from GitHub:
   ```bash
   curl -s https://raw.githubusercontent.com/icon97/awf/main/VERSION
   ```
...
```bash
curl -s https://raw.githubusercontent.com/icon97/awf/main/CHANGELOG.md | head -50
```
...
### For Mac/Linux:
```bash
curl -fsSL https://raw.githubusercontent.com/icon97/awf/main/install.sh | sh
```

### For Windows (PowerShell):
```powershell
iex "& { $(irm https://raw.githubusercontent.com/icon97/awf/main/install.ps1) }"
```
