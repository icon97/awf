...
## 🎮 UE5 Error Translations

### C++ Compile Errors
| Error | Message | Fix |
|-------|---------|-----|
| C2065 | undeclared identifier | Add #include or forward declare |
| C2511 | overloaded function not found | Match base class signature |
| C4430 | missing type specifier | Forward declare or #include |
| LNK2019 | unresolved external symbol | Implement in .cpp file |
| LNK2001 | unresolved external symbol | Add module to Build.cs |
...
| Cast failed | Wrong class type | Verify class before cast |
| Infinite loop | No exit condition | Add break condition |

### UE5 Runtime Errors
| Error | Cause | Fix |
|-------|-------|-----|
| Assertion failed | Check condition failed | Fix logic bug |
| Access violation | Null pointer | Check IsValid() |
| Garbage collected | Missing UPROPERTY | Add UPROPERTY() macro |

### Translation Format
```
🔴 Error: [Original Message]
📖 Giải thích: [Vietnamese explanation]
